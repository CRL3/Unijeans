    ...
    public partial class Login : Form
    {
        ...
        private void btn_login_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (con.Verificarlogin(txt_usuario.Text, label2.Text))
                {
                    try
                    {
                        ArrayList array = con.login(txt_usuario.Text, label2.Text);
                        ...
                        MessageBox.Show("Estamos aquiiiiiiii");
                        obj.Show();
                        this.Hide();
                    }
                    catch (Exception ex)
