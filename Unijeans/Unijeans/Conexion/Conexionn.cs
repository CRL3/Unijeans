...
namespace Unijeans.Conexion
{
    class Conexionn
    {
        ...
        public Conexionn()
        {
            ...
            conn.ConnectionString = "Data Source=(LocalDB)\\v11.0;AttachDbFilename=c:\\users\\hp\\documents\\visual studio 2013\\Projects\\Hospital\\Hospital\\BaseDatos.mdf;Integrated Security=True";
            try
            {
                conn.Open();
